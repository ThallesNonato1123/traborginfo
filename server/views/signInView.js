module.exports = function errorView(nome) {
    return `
    <!DOCTYPE html>
    <html lang="pt-br">
            ...
            <div id="main" class="offset-s3 col s6 hoverable">
                <nav id="nav">
                    <div class="nav-wrapper light-blue darken-4">
                        <p id="nav-text" class="center-align flow-text">Login Realizado</p>
                    </div>
                </nav>
    
                <div class="col s12">
                    <h3 style=" font-size: 30pt" class="center-align flow-text">Olá ${nome}!</h3>
