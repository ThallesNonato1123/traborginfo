module.exports = function errorView() {
    return `
    <!DOCTYPE html>
    <html lang="pt-br">
            ...
            <div id="main" class="offset-s3 col s6 hoverable">
                <nav id="nav">
                    <div class="nav-wrapper light-blue darken-4">
                        <p id="nav-text" class="center-align flow-text">Cadastro Realizado</p>
                    </div>
                </nav>
    
                <div class="col s12">
                    <h3 style=" font-size: 30pt" class="center-align flow-text">Usuário criado com sucesso.</h3>
